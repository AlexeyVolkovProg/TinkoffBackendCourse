...
public class ClientHandler implements Runnable{
    ...
    public String getResponse(String keyword) {
        switch (keyword.toLowerCase()) {
            case "личности":
                return RESPONSE_PREFIX + "Не переходи на личности там, где их нет";
            case "оскорбления":
                return RESPONSE_PREFIX + "Если твои противники перешли на личные оскорбления, " +
                    "будь уверен(а) — твоя победа не за горами";
            case "глупый":
                return RESPONSE_PREFIX + "А я тебе говорил, что ты глупый? Так вот, я забираю свои слова обратно... " +
                    "Ты просто бог идиотизма.";
            case "интеллект":
                return RESPONSE_PREFIX + "Чем ниже интеллект, тем громче оскорбления";
            default:
                return RESPONSE_PREFIX + "Неизвестное ключевое слово: " + keyword;
        }
    }
}
